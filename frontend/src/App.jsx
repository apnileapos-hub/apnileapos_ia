            ...
            <div style={{ position: "relative", zIndex: 10, margin: "auto 0" }}>
              ...
              <div style={{ borderTop: "1px solid rgba(255, 255, 255, 0.15)", paddingTop: "16px", maxWidth: "420px", width: "100%", marginBottom: "20px" }}>
                ...
                <div style={{
                  ...
                  >
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}><FaDesktop /> Company Sponsor</span>
                  </button>
                  ...
                  <button
                    ...
                    title="Connect as Company Project Mentor"
                    onMouseEnter={(e) => {
                  ...
                  >
                    <span style={{ display: "inline-flex", alignItems: "center", gap: "6px" }}><FaUser style={{ color: "#f97316" }} /> Company Mentor</span>
                  </button>
                </div>
